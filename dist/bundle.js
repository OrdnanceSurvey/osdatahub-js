...
},{"./names.js":3,"./ngd.js":4,"./places.js":5}],3:[function(require,module,exports){
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            responseObject.results.forEach(function (result) {
              coordsTemp = _coords.coords.fromBNG(result.GAZETTEER_ENTRY.GEOMETRY_X, result.GAZETTEER_ENTRY.GEOMETRY_Y);
              result.GAZETTEER_ENTRY.LNG = coordsTemp.lng;
              result.GAZETTEER_ENTRY.LAT = coordsTemp.lat;
            });
            return _context.abrupt("return", (0, _geojson.toGeoJSON)(responseObject));
          case 5:
          case "end":
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              pointBNG = _coords.coords.toBNG(pointSwivelled[0], pointSwivelled[1]);
              config.url = (0, _url.buildUrl)("names", "nearest", {
                point: "".concat(pointBNG.ea, ",").concat(pointBNG.no)
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              config = (0, _config.initialiseConfig)(apiKey, offset, limit);
...
},{"./utils/config.js":6,"./utils/coords.js":7,"./utils/geojson.js":9,"./utils/request.js":14,"./utils/url.js":15,"./utils/validate.js":16}],4:[function(require,module,exports){
"use strict";
...
var ngd = {
  ...
  collections: function collections() {
    var collectionId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
    return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var endpoint;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return (0, _crossFetch["default"])(endpoint).then(function (response) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              endpoint = _url.root + "".concat(collectionId, "/schema");
              _context4.next = 3;
              return (0, _crossFetch["default"])(endpoint).then(function (response) {
                return response.json();
              });
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              endpoint = _url.root + "".concat(collectionId, "/queryables");
              _context5.next = 3;
              return (0, _crossFetch["default"])(endpoint).then(function (response) {
                return response.json();
              });
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return (0, _request.get)(endpoint, apiKey).then(function (response) {
                return response.json();
              });
            case 3:
...
},{"./utils/config.js":6,"./utils/ngd/request.js":11,"./utils/ngd/url.js":12,"./utils/ngd/validate.js":13,"cross-fetch":17}],5:[function(require,module,exports){
"use strict";
...
function preprocessPlacesPolygon(geoJson) {
  try {
    if (isFeatureCollection(geoJson) && geoJson.features.length === 0) {
      ...
      throw new Error("Input feature collection has too many features. Expected 1, got ".concat(geoJson.features.length));
    }
    var geom;
    ...
    if (_coords.coords.isLngLat(geom.coordinates[0][0])) {
      geom.coordinates[0] = geom.coordinates[0].map(function (coordinate) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              config.url = (0, _url.buildUrl)("places", "polygon", params);
              config.method = "post";
              config.body = JSON.stringify(preprocessPlacesPolygon(_polygon));
              _context2.next = 9;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              config = (0, _config.initialiseConfig)(apiKey, offset, limit);
              pointSwivelled = _coords.coords.swivelPoint(point).toString().replaceAll(" ", "");
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              config = (0, _config.initialiseConfig)(apiKey, offset, limit);
              bboxSwivelled = _coords.coords.swivelBounds(_bbox).toString().replaceAll(" ", "");
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              config = (0, _config.initialiseConfig)(apiKey, offset, limit);
              config.url = (0, _url.buildUrl)("places", "postcode", {
                output_srs: "WGS84",
                postcode: _postcode
              });
              _context7.next = 5;
...
},{"./utils/config.js":6,"./utils/coords.js":7,"./utils/geojson.js":9,"./utils/request.js":14,"./utils/url.js":15,"./utils/validate.js":16}],6:[function(require,module,exports){
"use strict";
...
var coords = {
  fromBNG: function fromBNG(ea, no) {
    _proj["default"].defs("EPSG:27700", "+proj=tmerc +lat_0=49 +lon_0=-2 +k=0.9996012717 +x_0=400000 +y_0=-100000 +ellps=airy +towgs84=446.448,-125.157,542.06,0.15,0.247,0.842,-20.489 +units=m +no_defs");
    var point = (0, _proj["default"])("EPSG:27700", "EPSG:4326", [ea, no]);
  ...
  toBNG: function toBNG(lat, lng) {
    _proj["default"].defs("EPSG:27700", "+proj=tmerc +lat_0=49 +lon_0=-2 +k=0.9996012717 +x_0=400000 +y_0=-100000 +ellps=airy +towgs84=446.448,-125.157,542.06,0.15,0.247,0.842,-20.489 +units=m +no_defs");
    var point = (0, _proj["default"])("EPSG:4326", "EPSG:27700", [lng, lat]);
...
},{"proj4":18}],8:[function(require,module,exports){
"use strict";
...
var logging = {
  info: function info(message) {
    if (!process.env.NODE_ENV || ["development", "staging"].includes(process.env.NODE_ENV) || process.env.OSDATAHUB_FORCE_LOGGING) {
      console.log("[ osdatahub ] ".concat(message));
    }
  },
  warn: function warn(message) {
    if (!process.env.NODE_ENV || ["production", "staging"].includes(process.env.NODE_ENV) || process.env.OSDATAHUB_FORCE_LOGGING) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", (0, _crossFetch["default"])(endpoint, {
              method: "get",
              headers: {
                key: key
              }
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        ...
                        return body;
                      case 5:
                        if (!_context.sent.includes("InvalidApiKey")) {
                          _context.next = 7;
                          break;
                        }
                      ...
                      case 11:
                        ...
                        _context.t3 = _context.t1.parse.call(_context.t1, _context.t2).description;
...
function getOffsetEndpointNGD(config, featureCount) {
  var limit = Math.min(config.paging.limitValue - config.paging.startValue - featureCount, 100);
...
function request(config) {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var endpoint, featureCount, output, getEndpoint, response, responseJson;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            getEndpoint = config.paging.enabled ? getOffsetEndpointNGD : function () {
              return config.url;
            };
          case 3:
...
},{"../logging.js":10,"../request.js":14,"cross-fetch":17}],12:[function(require,module,exports){
"use strict";
...
function buildUrl(collectionId) {
  ...
  var subdirs = "".concat(collectionId, "/items").concat(featureId ? "/".concat(featureId, "?") : "?");
  return root + subdirs + query;
}

},{"../crs.js":8}],13:[function(require,module,exports){
"use strict";
...
var validate = {
  bbox: function bbox(_bbox) {
    if (_bbox[0] > _bbox[2] || _bbox[1] > _bbox[3]) {
      throw new Error("Invalid bounding box (bbox), expected [minLng, minLat, maxLng, maxLat] or [minLat, minLng, maxLat, maxLng]");
    }
    return true;
  },
...
function getOffsetEndpoint(config, featureCount) {
  var limit = Math.min(config.paging.limitValue - config.paging.startValue - featureCount, 100);
  return config.url + "&offset=" + config.paging.position + "&maxresults=" + limit;
}
...
function logEndConditions(config, featureCount) {
  if (config.paging.position == config.paging.limitValue) {
    _logging.logging.warn("\uD83D\uDD38 The hard limit (".concat(config.paging.limitValue, " features) was reached. Additional features may be available to collect."));
  } else {
    _logging.logging.info("\uD83D\uDD39 All features (".concat(featureCount, ") have been collected."));
  }
}
function continuePaging(config) {
  return config.paging.isNextPage && config.paging.position < config.paging.limitValue;
}
function request(config) {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var endpoint, featureCount, output, getEndpoint, getData, response, responseJson;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            featureCount = 0;
            getEndpoint = config.paging.enabled ? getOffsetEndpoint : function () {
              return config.url;
            };
...
},{"./logging.js":10,"cross-fetch":17}],15:[function(require,module,exports){
"use strict";
...
var validate = {
  ...
  point: function point(_point) {
    if (_point[0] > _point[1]) {
      // [Lat Lng]
      if (_point[0] < 49.781264 || _point[1] < -7.910156 || _point[0] > 59.164668 || _point[1] > 2.043457) {
        throw new Error("Invalid Point, not within the UK (Lng, Lat): [-7.910156, 49.781264, 2.043457, 59.164668]");
      }
    } else {
      if (_point[1] < 49.781264 || _point[0] < -7.910156 || _point[1] > 59.164668 || _point[0] > 2.043457) {
        throw new Error("Invalid Point, not within the UK (Lng, Lat): [-7.910156, 49.781264, 2.043457, 59.164668]");
      }
    }
    return true;
  ...
  polygon: function polygon(_polygon) {
    if (isFeature(_polygon) && !isPolygon(_polygon.geometry)) {
      throw new Error("Expected Polygon, got ".concat(_polygon.geometry.type));
    }
    if (isFeatureCollection(_polygon) && !isPolygon(_polygon.features[0].geometry)) {
      throw new Error("Expected Polygon, got ".concat(_polygon.features[0].geometry.type));
    }
  },
  bbox: function bbox(_bbox) {
    if (_bbox[0] > _bbox[2] || _bbox[1] > _bbox[3]) {
    ...
    if (_bbox[0] > _bbox[1]) {
      // [Lat Lng]
      if (_bbox[0] < 49.781264 || _bbox[1] < -7.910156 || _bbox[2] > 59.164668 || _bbox[3] > 2.043457) {
        throw new Error("Invalid bounding box (bbox), not within the UK (Lng, Lat): [-7.910156, 49.781264, 2.043457, 59.164668]");
      }
    } else {
      if (_bbox[1] < 49.781264 || _bbox[0] < -7.910156 || _bbox[3] > 59.164668 || _bbox[2] > 2.043457) {
        throw new Error("Invalid bounding box (bbox), not within the UK (Lng, Lat): [-7.910156, 49.781264, 2.043457, 59.164668]");
      }
    }
    return true;
  ...
  postcode: function postcode(_postcode) {
    ...
    if (!query.test(_postcode)) {
      throw new Error("Invalid Postcode: The minimum for the resource is the area and district e.g. SO16");
    }
  },
  uprn: function uprn(_uprn) {
    if (!Number.isInteger(_uprn) || _uprn < 0 || _uprn.toString().length > 12) {
      throw new Error("Invalid UPRN, should be a positive integer (max. 12 digits)");
    }
  }
};
function validateParams(params) {
